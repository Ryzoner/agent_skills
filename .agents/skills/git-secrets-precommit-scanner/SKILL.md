...
description: "Сканирование git diff на утечку секретов (truffleHog + regex), pre-commit hook, GitHub push protection. Триггеры: сканируй секреты, pre-commit secrets, trufflehog, push protection, leaked credentials, утечка токенов, проверь diff на секреты."
---
